...
NOISE_KERNEL_SIZE =  3, 3 # For median: int (odd); for gaussian: (int, int) like (3,3)
...
ADAPTIVE_BLOCK_SIZE = 7      # odd number, size of pixel neighbourhood
...
UPSCALE_FACTOR = 5  # Set to 1 for no upscale
...
IMAGE_PATHS = 'images/processed_flinzar.jpg'  # ← CHANGE THIS! (str, list, or folder path)
