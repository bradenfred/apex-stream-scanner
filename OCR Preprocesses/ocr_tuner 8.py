...
NOISE_KERNEL_SIZE = 5, 3  # For median: int (odd); for gaussian: (int, int) like (3,3)
...
BINARIZE_METHOD = 'adaptive' # Set to "simple" or "adaptive" to enable; False to skip
...
ADAPTIVE_BLOCK_SIZE = 17      # odd number, size of pixel neighbourhood
ADAPTIVE_C = 12                # constant subtracted from the mean
...
EROSION_KERNEL_SIZE = (1,1)  # Shape of the structuring element
...
DILATION_KERNEL_SIZE = (1, 1)  # Shape of the structuring element
...
IMAGE_PATHS = 'images/processed_jomacs.jpg'  # ← CHANGE THIS! (str, list, or folder path)
