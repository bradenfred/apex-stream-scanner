...
ADAPTIVE_BLOCK_SIZE = 21      # odd number, size of pixel neighbourhood
ADAPTIVE_C = 5                # constant subtracted from the mean
...
IMAGE_PATHS = 'images/processed_kimchilee.jpg'  # ← CHANGE THIS! (str, list, or folder path)
