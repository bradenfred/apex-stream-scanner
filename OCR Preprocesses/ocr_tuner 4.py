...
NOISE_KERNEL_SIZE = 3  # For median: int (odd); for gaussian: (int, int) like (3,3)
...
EROSION_KERNEL_SIZE = (2,2)  # Shape of the structuring element
...
DILATION_KERNEL_SIZE = (1, 2)  # Shape of the structuring element
...
IMAGE_PATHS = 'images/raw_crop_fuzzylumpcat.jpg'  # ← CHANGE THIS! (str, list, or folder path)
